...
class TestDecryptErrors:
    ...
    def test_missing_scrypt_magic_base64(self, runner):
        ...
        assert result.exit_code == 1
        assert "missing scrypt magic header" in _err_text(result)

    def test_missing_scrypt_magic_binary(self, runner):
    ...
    def test_truncated(self, runner):
        ...
        assert result.exit_code == 1
        assert "truncated scrypt file" in _err_text(result)
